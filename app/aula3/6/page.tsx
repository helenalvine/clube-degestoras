import { Target, Heart, Trophy, CheckCircle } from 'lucide-react';

const traits = ['Calma', 'Paciente', 'Cooperativa'];
const strengths = [
  'Confiável',
  'Trabalha bem em equipe',
  'Mantém estabilidade na crew'
];
const conflicts = ['Pode resistir a mudanças', 'Demora para tomar decisões'];
    ...
    <div className="relative overflow-hidden w-[1920px] h-[1080px] bg-[#1A0A2E] flex flex-col">
      ...
      <div className="flex-none pt-16 pb-8 px-24">
        <div className="flex items-center gap-6">
          <div className="w-24 h-24 rounded-full bg-[#22C55E] flex items-center justify-center">
            <span className="font-montserrat font-bold text-6xl text-white">S</span>
          </div>
          <div>
      ...
      <div className="flex-1 grid grid-cols-3 gap-8 px-24">
        ...
        <div className="bg-white/5 rounded-2xl p-8">
          <div className="flex items-center gap-4 mb-6">
            <Target className="text-[#22C55E]" size={36} />
        ...
        {/* Strengths */}
        <div className="bg-[#22C55E]/10 rounded-2xl p-8 border-l-4 border-[#22C55E]">
          <div className="flex items-center gap-4 mb-6">
            <Trophy className="text-[#22C55E]" size={36} />
